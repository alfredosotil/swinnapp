            ...
            'access' => [
                ...
                'rules' => [
                    [
                        ...
                        'allow' => AppAsset::getAccess("ideas"),
                        'roles' => ['@'],
                    ],
                ],
            ],
...
//                    'searchModel' => $searchModel,
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                ...
                return [
                    'forceReload' => 'true',
                    'title' => "Create new Ideas",
                    'content' => '<span class="text-success">Create Ideas success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
    ...
    /**
     * Delete an existing Ideas model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing Ideas model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    public function actionBulkDelete() {
        ...
        foreach (Ideas::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
