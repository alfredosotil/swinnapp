            ...
            <div class="content-wrap">
                ...
                <div class="content-elastic">
                    <div class="container"> 
                        <?php $this->beginBody() ?>
                        <div class="row" style="">
                            <div id="logo" class="col-lg-1 wow pulse pull-left" data-wow-iteration="infinite" data-wow-duration="1000ms"></div>
                            <div id="title-app" class="page-header pull-left wow fadeIn" data-wow-duration="1000ms" data-wow-delay="" ><h1><span><?= Html::encode(Yii::$app->params['appname']); ?></span></h1></div>
                            <div class="col-lg-2 pull-right">
                                ...
                                <div id="user-logued" class="wow fadeIn" data-wow-duration="1000ms" data-wow-delay="" >
                                    <i class='fa fa-fw fa-user fa-2x'></i><span><?= isset(Yii::$app->user->identity->username) ? Yii::$app->user->identity->username : "no-user" ?></span>
                                </div>
                            </div>
                            <!--<div class="row">-->
